    ...
    try {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            if (data[i]["AL"] > 0) {
                ...
                Gehalt["F18"] = 1;
                Gehalt["M52"] =
                    Math.round(Gehalt["M52"] - data[i]["AL"] * 100) / 100;
            } else {
                Gehalt["E18"] = 0;
                Gehalt["F18"] = 0;
            }
            ...
            if (data[i]["AR"] > 0) {
                ...
                if (data[i]["AS"] === "ja") {
                    Gehalt["M52"] =
                        Math.round(Gehalt["M52"] - data[i]["AR"] * 100) / 100;
                }
            } else {
                Gehalt["E23"] = 0;
                Gehalt["F23"] = 0;
            ...
            if (data[i]["AT"] > 0) {
                ...
                if (data[i]["AU"] === "ja") {
                    Gehalt["M52"] =
                        Math.round(Gehalt["M52"] - data[i]["AT"] * 100) / 100;
                }
            } else {
                Gehalt["E24"] = 0;
                Gehalt["F24"] = 0;
            ...
            if (data[i]["BC"] > 0) {
                ...
                if (data[i]["BD"] === "ja") {
                    Gehalt["M52"] =
                        Math.round(Gehalt["M52"] - data[i]["BC"] * 100) / 100;
                }
            } else {
                Gehalt["E26"] = 0;
                Gehalt["F26"] = 0;
            ...
            if (data[i]["AN"] > 0) {
                ...
                if (data[i]["AO"] === "ja") {
                    Gehalt["M52"] =
                        Math.round(Gehalt["M52"] - data[i]["AN"] * 100) / 100;
                }
            } else {
                Gehalt["E28"] = 0;
                Gehalt["F28"] = 0;
            ...
            if (data[i]["BI"] > 0) {
                ...
                if (data[i]["BJ"] === "ja") {
                    Gehalt["M52"] =
                        Math.round(Gehalt["M52"] - data[i]["BI"] * 100) / 100;
                }
            } else {
                Gehalt["E29"] = 0;
                Gehalt["F29"] = 0;
            ...
            if (data[i]["BM"] > 0) {
                ...
                if (data[i]["BN"] === "ja") {
                    Gehalt["M52"] =
                        Math.round(Gehalt["M52"] - data[i]["BM"] * 100) / 100;
                }
            } else {
                Gehalt["E30"] = 0;
                Gehalt["F30"] = 0;
            ...
            if (data[i]["BK"] > 0) {
                ...
                if (data[i]["BL"] === "ja") {
                    Gehalt["M52"] =
                        Math.round(Gehalt["M52"] - data[i]["BK"] * 100) / 100;
                }
            } else {
                Gehalt["E31"] = 0;
                Gehalt["F31"] = 0;
